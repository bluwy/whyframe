...
- Building documentation for a component library and you need to show isolated examples.
- Writing an article that requires showing static isolated examples.
- Building your a [Storybook](https://storybook.js.org) clone.

It cannot be used to:

- Build interactive code examples. It only works in compile-time.
- Create `iframe`s dynamically or using through a CDN. It requires a JavaScript bundler.

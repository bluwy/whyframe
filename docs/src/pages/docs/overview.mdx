...
Or all templates at a glance:

- [Vite + Svelte](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/vite-svelte)
- [Vite + Vue](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/vite-vue)
- [Vite + Solid](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/vite-solid)
- [Vite + Preact](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/vite-preact)
- [Vite + React](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/vite-react)
- [SvelteKit](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/sveltekit)
- [Astro](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/astro)
- [VitePress](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/vitepress)
- [Nuxt](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/nuxt)
- [Webpack + React](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/webpack-react)
- [Next](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/next)
- [Docusaurus](https://stackblitz.com/fork/github/bluwy/whyframe/tree/master/playground/ocusaurus)

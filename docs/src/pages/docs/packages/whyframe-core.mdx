...
`@whyframe/core` exports a [Vite](https://vitejs.dev) plugin, while `@whyframe/core/webpack` exports a [Webpack](https://webpack.js.org) plugin. They share the same options below:
